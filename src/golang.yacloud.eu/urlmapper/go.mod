...
require (
	golang.conradwood.net/apis/common v1.1.3084
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3084 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.3084 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3084 // indirect
